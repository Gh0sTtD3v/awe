...
import { ShaderMaterial, Vector3, UniformsLib, DoubleSide } from "three";

import { DPI, FONT_DISTANCE_RANGE_FIELD, GLOBAL_TEXT_SCALE } from "../constants";

import VertexShader from "./shader/main.vert.ts";

import FragmentShader from "./shader/main.frag.ts";
...
export default class MSDFMaterial extends ShaderMaterial {
    constructor(options = {}) {
        ...
        // @ts-ignore - extensions.derivatives is valid WebGL but not in TS types
        super(opts)

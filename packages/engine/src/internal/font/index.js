...
import FontWrapper from './wrapper';

import MSDFMaterial from './material';
...
import { Subsystems, loadJson } from "../subsystems";

import DATA from './data';

import FontInstancedMesh from './instanced/mesh'

import FontInstancedWrapper from './instanced/wrapper'
...
class FontMeshFactory {
    ...
    async loadFont(n, instanced = false, instancedBillBoard = false) {
        ...
        const p =  new Promise((resolve) => {
            ...
            ps.push(Subsystems.textures.loadTexture(fontData.tex));

            ps.push(loadJson(fontData.json));

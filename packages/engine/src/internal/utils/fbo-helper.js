...
export default class THREEFBOHelper {
    constructor(renderer) {
        ...
        this.grid.addEventListener("mousemove", (e) => {
            if (dragging) {
                this.offsetX =
                    offsetStart.x +
                    (e.clientX - mouseStart.x) / this.camera.zoom;
                this.offsetY =
                    offsetStart.y +
                    (e.clientY - mouseStart.y) / this.camera.zoom;
    ...
    readPixel(obj, u, v) {
        ...
        if (fbo.isDataTexture == true) {
            ...
            pixelBuffer[1] =
                fbo.source.data.data[index * component + 1].toFixed(4);
            pixelBuffer[2] =
                fbo.source.data.data[index * component + 2].toFixed(4);
            pixelBuffer[3] =
                fbo.source.data.data[index * component + 3].toFixed(4);

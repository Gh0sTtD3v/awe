...
import PreVertex  from './shader/ghost/pre.vertex.glsl.ts'

import MainVertex from './shader/ghost/main.vertex.glsl.ts'

import SuffVertex from './shader/ghost/suff.vertex.glsl.ts'

import PreFrag    from './shader/ghost/pre.frag.glsl.ts'

import MainFrag   from './shader/ghost/main.frag.glsl.ts'

import SuffFrag   from './shader/ghost/suff.frag.glsl.ts'

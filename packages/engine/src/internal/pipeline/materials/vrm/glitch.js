...
import PreVertex  from './shader/glitch/pre.vertex.glsl.ts'

import MainVertex from './shader/glitch/main.vertex.glsl.ts'

import SuffVertex from './shader/glitch/suff.vertex.glsl.ts'

import PreFrag    from './shader/glitch/pre.frag.glsl.ts'

import MainFrag   from './shader/glitch/main.frag.glsl.ts'

import SuffFrag   from './shader/glitch/suff.frag.glsl.ts'

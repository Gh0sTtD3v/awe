...
import InstancedLambert from "../rendering/materials/instancedlambert";
...
import InstancedOcclusion from "../rendering/materials/instancedocclusion";

import InstancedBasic from "../rendering/materials/instancedbasic";

import InstancedToon from "../rendering/materials/instancedtoon";

import InstancedOutline from "../rendering/materials/instancedoutline";

import {
  InstancedGlitchLambert,
  InstancedGlitchBasic,
} from "../rendering/materials/instancedglitch";

import {
  InstancedGhostBasic,
  InstancedGhostLambert,
} from "../rendering/materials/instancedghost";
...
import MeshOutlineMaterial from "../rendering/materials/outline";

import {
  GlitchBasic,
  GlitchLambert,
} from "../rendering/materials/glitch";

import {
  GhostBasic,
  GhostLambert,
} from "../rendering/materials/ghost";
...
class ModelPipeline {
  ...
  get(mesh, geometry, originalMaterial, opts) {
    ...
    if (opts.instance) {
      ...
      return this.assignModelDefault(newMesh, geometry, originalMaterial, opts);
    }
  }
    ...
    switch (opts.renderMode) {
      ...
      case RENDER_MODES.ERROR:
        ...
        const parameters = {
          uniforms: {
            rimPower: {
              value: opts.renderMode == RENDER_MODES.ERROR ? 0.5 : 1.0,
            },
            minAlpha: {
              value: opts.renderMode == RENDER_MODES.ERROR ? 0.2 : 0.05,
            },
          },

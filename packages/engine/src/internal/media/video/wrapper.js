...
export default class VideoWrapper extends Object3D {
    constructor(textures = {}, videoData = {}, data = {}) {
        ...
        if (videoData.video) {
            this.scaleRatio =
                videoData.video.videoWidth / videoData.video.videoHeight;

            this.scale.set(this.scaleRatio, 1, 1);
        } else {
            this.scaleRatio = 1;
        }
    ...
    play() {
        ...
        if (this._isPlaying == false) {
            ...
            this.mesh.lightingMaterials.material.map =
                this.videoData.videoTexture;

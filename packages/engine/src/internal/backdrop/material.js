...
export default class BackDropMaterial extends ShaderMaterial {
    ...
    setColorsWithTransition( options, duration = 1 ){
        ...
        return new Promise((resolve, reject )=>{
            ...
            ps.push( this.transitionFromTo( this.uniforms.floor.value,    tempC0, duration ) )
            ps.push( this.transitionFromTo( this.uniforms.wall.value,     tempC1, duration ) )
            ps.push( this.transitionFromTo( this.uniforms.horizon.value,  tempC2, duration ) )

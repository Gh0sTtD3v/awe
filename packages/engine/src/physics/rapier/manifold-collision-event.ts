...
import type { CollisionEnterEvent, ContactPoint } from "../types";
...
export class ManifoldCollisionEvent implements CollisionEnterEvent {
  //
  constructor(
    private _physics: RapierPhysicsEngine,
  ...
  get contactPoints() {
    ...
    const source1 = this.me.collider.raw as RapierRawCollider;
    const source2 = this.other.collider.raw as RapierRawCollider;

...
import { COLLIDER_TYPES, RIGIDBODY_TYPES } from "../constants";
import {
...
import { RapierRigidBody } from ".";
import { CollisionFSM } from "./collision-fsm";
...
export class RapierCollider implements Collider {
    ...
    private static _rawCollidersMap = new WeakMap<RapierRawCollider, RapierCollider>();

    static getFromRaw(raw: RapierRawCollider) {
        //
    ...
    private _rawCollider: RapierRawCollider;
    ...
    constructor(
        ...
        private _parent: RapierRigidBody
    ) {
        //
    ...
    private _createCollider() {
        ...
        switch (opts.type) {
            ...
            default:
                throw new Error(
                    `Unsupported collider type: ${(opts as any).type}`
                );
        }
        ...
        RapierCollider._rawCollidersMap.set(this._rawCollider, this);
    }
    ...
    dispose(wakeUpParent: boolean = true) {
        ...
        if (this._rawCollider) {
            //
            RapierCollider._rawCollidersMap.delete(this._rawCollider);
    ...
    private _hasCollisionEvents() {
        //
        return (
            this.component.hasListeners(
                this.component.EVENTS.COLLISION_ENTER
            ) ||
    ...
    private _fsms: Map<RapierCollider, CollisionFSM> = new Map();

...
import { MeshComponentHeadless } from "./mesh-component-headless";

/** @internal */
export class MeshComponentFactoryHeadless extends DefaultComponentFactory<MeshComponentHeadless> {
  Type = MeshComponentHeadless;

import { Component3D, ComponentOpts } from "../../abstract/component-3d";
import { ComponentMixin } from "../../abstract/component-mixin";
import {
    ColliderOpts,
    RigidBodyOpts,
    COLLIDER_TYPES,
...
import { ComponentFactoryOptions } from "../../abstract/component-factory";
...
export class ComponentPhysicsMixin implements ComponentMixin {
    ...
    private _SIMPLE_getColliderOpts(
        ...
        colliderArray.forEach((opts) => {
            ...
            const _opts = {
                ...
                position: shapeOpts.position,
                radius: shapeOpts.radius,
                height: shapeOpts.height,
                width: shapeOpts.width,
                depth: shapeOpts.depth,
            };
    ...
    async init(component: Component3D) {
        ...
        const enabled = colliderOpts != null && (colliderOpts.enabled ?? true);

        if (!enabled || component.getCollisionMesh() == null) return;
